...
datos <- read.csv("D:\\Users\\Josef\\Desktop\\mpg.csv")
...
#   Muestra Pruebas
prueba.f.subcompact.ford.vs.volkswagen #  p-value = 0.06363891, NO hay diferencia
prueba.f.subcompact.ford.vs.subaru #  p-value = 0.06113, No hay diferencia
prueba.f.subcompact.ford.vs.hyundai # p-value = 0.9737, No hay diferencia
prueba.f.subcompact.ford.vs.honda # p-value = 0.7608, No hay diferencia

prueba.f.subcompact.honda.vs.volkswagen # p-value = 0.002537, SI hay diferencia
prueba.f.subcompact.honda.vs.subaru # p-value = 0.04463, SI hay diferencia
prueba.f.subcompact.honda.vs.hyundai # p-value = 0.8057, No hay diferencia

prueba.f.subcompact.hyundai.vs.volkswagen # p-value = 0.004282, SI hay diferencia
prueba.f.subcompact.hyundai.vs.subaru # p-value = 0.0625, No hay diferencia

prueba.f.subcompact.subaru.vs.volkswagen # p-value = 0.001123, Si hay diferencia

#Pruebas T de SUBCOMPACT

t.test(ford.subcompact$mpg.general, volkswagen.subcompact$mpg.general, var.equal = TRUE)
# p-value = 0.002831
t.test(ford.subcompact$mpg.general, volkswagen.subcompact$mpg.general, var.equal = TRUE, alternative = "less")
# p-value = 0.001415, Volkswagen es más eficiente que ford.

t.test(honda.subcompact$mpg.general, volkswagen.subcompact$mpg.general, var.equal = FALSE)
# p-value = 0.9784, no hay diferencia significativa en eficiencia.

t.test(hyundai.subcompact$mpg.general, volkswagen.subcompact$mpg.general, var.equal = FALSE)
# p-value = 0.08138, no hay diferencia significativa en eficiencia.

t.test(subaru.subcompact$mpg.general, volkswagen.subcompact$mpg.general, var.equal = FALSE)
# p-value = 0.1058, no hay diferencia significativa en eficiencia

t.test(honda.subcompact$mpg.general, hyundai.subcompact$mpg.general, var.equal = TRUE)
# p-value = 1.094e-05
t.test(honda.subcompact$mpg.general, hyundai.subcompact$mpg.general, var.equal = TRUE, alternative = "less")
# p-value = 1, Honda es más eficiente que hyundai.

t.test(honda.subcompact$mpg.general, subaru.subcompact$mpg.general, var.equal = FALSE)
# p-value = 1.079e-05
t.test(honda.subcompact$mpg.general, subaru.subcompact$mpg.general, var.equal = FALSE, alternative = "less")
# p-value = 1, Honda es más eficiente que subaru.

t.test(volkswagen.subcompact$mpg.general, subaru.subcompact$mpg.general, var.equal = TRUE)
# p-value = 0.1538, no hay diferencia significativa en eficiencia.

#Conclusión, Honda es más eficiente en autos subCompactos, sin embargo,
# no tiene una diferencia estadísticamente significativa con VolksWagen, pero al ser
# más eficiente que Subaru que tampoco tiene una diferencia estadísticamente significativa con
# volkswagen por lo que declaramos como más eficiente a Honda.
...
#     Muestra pruebas
prueba.f.pickup.ford.vs.dodge # p-value = 0.0455, Si hay diferencia
prueba.f.pickup.ford.vs.toyota # p-value = 0.001123, Si hay diferencia

prueba.f.pickup.toyota.vs.dodge # p-value = 0.4901, No hay diferencia

#Pruebas T PICKUPS

t.test(ford.pickup$mpg.general, dodge.pickup$mpg.general, var.equal = FALSE)
# p-value = 0.2692, no hay una diferencia significativa en eficiencia.

t.test(ford.pickup$mpg.general, toyoya.pickup$mpg.general, var.equal = FALSE)
# p-value = 0.000325
t.test(ford.pickup$mpg.general, toyoya.pickup$mpg.general, var.equal = FALSE, alternative = "less")
# p-value = 0.0001625, toyota es más eficiente que ford.

t.test(dodge.pickup$mpg.general, toyoya.pickup$mpg.general, var.equal = TRUE)
# p-value = 0.0002812
t.test(dodge.pickup$mpg.general, toyoya.pickup$mpg.general, var.equal = TRUE, alternative = "less")
# p-value = 0.0001406, toyota es más eficiente que dodge.

#  Conclusión: los pickups toyota son los más eficientes.
